  ...
  export default  {
    ...
    methods: {
      ...
      addNewRepresentant(){
        ...
        {
            axios.post('/client/create_new_representant',  {representant: this.representant}).then(response => {
              ...
              {
                alert('Le representant: '+ rep.prenom +' '+ rep.nom +' a ete bien ajouter a votre liste client!');
    ...
    watch: {
      client_id: function(val){
        this.representant.client_id = val;
      }
    },
    computed: {
