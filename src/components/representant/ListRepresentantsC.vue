    ...
    <div>
      <div class="col">
        ...
        <div class="row justify-content-end mr-3 " v-if="showAdd">
          <div class="col">
            <CreateRepresentant :client_id="id" @update-representants="getAllRepresentants">
...
import CreateRepresentant from './CreateRepresentantC.vue'
import UpdateRepresentant from './UpdateRepresentantC.vue'
  ...
  export default  {
    ...
    methods: {
      ...
      getAllRepresentants(){
          axios.get('client/all_representants/'+this.id).then(response => {
      ...
      deleteRepresentantById(val)
      {
        ...
        {
          axios.delete('/client/delete_representant',  {data: {id: val.id}}).then(response => {
            this.getAllRepresentants();
          }, () => {
            alert('Error sorry we have any data');
          });
